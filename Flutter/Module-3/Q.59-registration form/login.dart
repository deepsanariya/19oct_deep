...
import 'package:lohin111/main.dart';
      ...
      (
        ...
        child: Container
          ...
          child: Column
            ...
            children:
            [
              Text("Signup",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.pinkAccent)),
              SizedBox(height: 50,),
              ...
              TextFormField
                ...
                decoration: InputDecoration(hintText: "Enter Your Current Password",border: OutlineInputBorder()),
                validator: (value)
                {
                  if (value!.isEmpty)
                  {
              ...
              MaterialButton(onPressed: ()
              {
                if(_formKey.currentState!.validate())
                {
                  ...
                  if(email1=="deep@gmail.com" && pass1=="123456" && pass2=="123456")
                  {
